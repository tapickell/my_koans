...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why?
		# Not sure exactly. If the only point of the original string was to
		# equal the cat string then that is good but you lose the oringinal string
		# would not be helpful if the original string needed to be reused elsewhere
  end
